 ...
 *
 * @param {String}   xmlStr
 * @param {String}   [typeName='rem:Definitions'] name of the root element
 ...
 *
 * @param {String}   element    the root element, typically an instance of `rem:Definitions`
