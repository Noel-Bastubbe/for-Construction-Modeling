...
/*
DependencyModeler.prototype.addOlc = function (clazz) {
...
/*
DependencyModeler.prototype.getCurrentOlc = function () {
  return this._olc;
}
 */

/*
DependencyModeler.prototype.deleteCurrentOlc = function () {
  this.deleteOlc(this._olc.classRef);
}
 */

/*
DependencyModeler.prototype.deleteOlc = function (clazz) {
...
/*
DependencyModeler.prototype.renameOlc = function (name, clazz) {
...
/*
DependencyModeler.prototype.getOlcById = function(id) {
  return this.getOlcs().filter(olc => olc.id === id)[0];
}
 */

/*
DependencyModeler.prototype.getOlcByClass = function(clazz) {
...
/*
DependencyModeler.prototype.getOlcs = function() {
