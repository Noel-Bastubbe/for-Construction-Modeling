...
function isGroup(element) {
  return is(element, 'om:Group') && !element.labelTarget;
}
...
function canConnectLink(source, target) {
  return is(source, 'om:Object') && is(target, 'om:Object');
}
...
function canDrop(element, target) {
  ...
  return is(element, 'om:BoardElement') && is(target, 'om:OdBoard');
}
