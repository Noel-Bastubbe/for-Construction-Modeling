...
Mediator.prototype.DataModelerHook = function (eventBus, dataModeler) {
  ...
  AbstractHook.call(
    ...
    dataModeler,
    "Data Model",
    "https://github.com/bptlab/fCM-design-support/wiki/Data-Model"
  );
...
Mediator.prototype.FragmentModelerHook = function (eventBus, fragmentModeler) {
  ...
  AbstractHook.call(
    ...
    fragmentModeler,
    "Fragments",
    "https://github.com/bptlab/fCM-design-support/wiki/Fragments"
  );
...
Mediator.prototype.OlcModelerHook = function (eventBus, olcModeler) {
  ...
  AbstractHook.call(
    ...
    olcModeler,
    "OLCs",
    "https://github.com/bptlab/fCM-design-support/wiki/Object-Lifecycle-(OLC)"
  );
